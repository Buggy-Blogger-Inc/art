...
public class CommentControllerTest {
    ...
    public static void clearDatabase() {
        EntityManagerFactory factory = Persistence.createEntityManagerFactory(AppConfig.PERSISTENCE_UNIT_NAME);
    ...
    void validateMultipleUpdatedComment(List<Comment> commentList, Blog blogPost, String commentBase,
            int numOfComments) {
        for (int i = 0; i < numOfComments; i++) {
            try {
                // make update message string
    ...
    private int navigateForwardByBlog(long blogId, int totalComment) throws DataNotFoundException, EntityException {
        ...
        int page = 0;
        // traverse total number of page based on total comment and
        ...
        for (page = 0; page < totalComment / AppConfig.MAX_COMMENTS_PAGE_SIZE; page++) {
            ...
            // validate number of comment should not increase
            // MAX_COMMENTS_PAGE_SIZE
    ...
    private int navigateBackwardsByBolg(long blogId, int totalComment) throws DataNotFoundException, EntityException {
        ...
        for (; page >= 0; page--) {
            ...
            logger.info("COMMENT COUNT = " + commentCount);
            // validate number of comments per page should not exceed
            // MAX_COMMENTS_PAGE_SIZE
            assert (commentCount == AppConfig.MAX_COMMENTS_PAGE_SIZE);
